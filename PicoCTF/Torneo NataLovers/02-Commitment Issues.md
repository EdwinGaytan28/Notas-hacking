...
## Solucion
```bash
┌──(kali㉿kali)-[~/Documentos/retosConcursoPico/commitmentIssues]
└─$ cd drop-in         
                                                                            
┌──(kali㉿kali)-[~/Documentos/retosConcursoPico/commitmentIssues/drop-in]
└─$ ls
message.txt
                                                                            
┌──(kali㉿kali)-[~/Documentos/retosConcursoPico/commitmentIssues/drop-in]
└─$ git init
Reinicializado el repositorio Git existente en /home/kali/Documentos/retosConcursoPico/commitmentIssues/drop-in/.git/
