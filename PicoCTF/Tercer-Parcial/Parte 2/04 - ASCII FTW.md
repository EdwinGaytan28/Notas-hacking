...
edwin2809-picoctf@webshell:~$ chmod +x asciiftw
edwin2809-picoctf@webshell:~$ objdump -d asciiftw
...
0000000000001169 <main>:
    ...
    11dc:       c6 45 e6 33             movb   $0x33,-0x1a(%rbp)
    11e0:       c6 45 e7 43             movb   $0x43,-0x19(%rbp)
    11e4:       c6 45 e8 46             movb   $0x46,-0x18(%rbp)
    11e8:       c6 45 e9 34             movb   $0x34,-0x17(%rbp)
    11ec:       c6 45 ea 42             movb   $0x42,-0x16(%rbp)
    11f0:       c6 45 eb 46             movb   $0x46,-0x15(%rbp)
...
00000000000012b8 <_fini>:
    ...
    12c4:       c3                      ret    
edwin2809-picoctf@webshell:~$ objdump -d asciiftw > disassembled_asciiftw.txt
edwin2809-picoctf@webshell:~$ cat disassembled_asciiftw.txt | grep "<main>:" -A 40
0000000000001169 <main>:
    1169:       f3 0f 1e fa             endbr64 
    116d:       55                      push   %rbp
    116e:       48 89 e5                mov    %rsp,%rbp
    ...
    11fc:       c6 45 ee 7d             movb   $0x7d,-0x12(%rbp)
    1200:       0f b6 45 d0             movzbl -0x30(%rbp),%eax
edwin2809-picoctf@webshell:~$ cat disassembled_asciiftw.txt | grep "<main>:" -A 40 | grep movb
    1184:       c6 45 d0 70             movb   $0x70,-0x30(%rbp)
    1188:       c6 45 d1 69             movb   $0x69,-0x2f(%rbp)
    118c:       c6 45 d2 63             movb   $0x63,-0x2e(%rbp)
    1190:       c6 45 d3 6f             movb   $0x6f,-0x2d(%rbp)
    ...
    11f8:       c6 45 ed 44             movb   $0x44,-0x13(%rbp)
    11fc:       c6 45 ee 7d             movb   $0x7d,-0x12(%rbp)
edwin2809-picoctf@webshell:~$ cat disassembled_asciiftw.txt | grep "<main>:" -A 40 | grep movb | cut -d "$" -f2
0x70,-0x30(%rbp)
0x69,-0x2f(%rbp)
0x63,-0x2e(%rbp)
0x6f,-0x2d(%rbp)
...
0x44,-0x13(%rbp)
0x7d,-0x12(%rbp)
edwin2809-picoctf@webshell:~$ cat disassembled_asciiftw.txt | grep "<main>:" -A 40 | grep movb | cut -d "$" -f2 | cut -d "," -f1
0x70
0x69
0x63
0x6f
...
0x44
0x7d
edwin2809-picoctf@webshell:~$ cat disassembled_asciiftw.txt | grep "<main>:" -A 40 | grep movb | cut -d "$" -f2 | cut -d "," -f1 | tr -d "\n"
0x700x690x630x6f0x430x540x460x7b0x410x530x430x490x490x5f0x490x530x5f0x450x410x530x590x5f0x330x430x460x340x420x460x410x440x7dedwin2809-picoctf@webshell:~$ cat disassembled_asciiftw.txt | grep "<main>:" -A 40 | grep movb | cut -d "$" -f2 | cut -d "," -f1 | tr -d "\n" | sed 's\0x\ 0x\g'
 0x70 0x69 0x63 0x6f 0x43 0x54 0x46 0x7b 0x41 0x53 0x43 0x49 0x49 0x5f 0x49 0x53 0x5f 0x45 0x41 0x53 0x59 0x5f 0x33 0x43 0x46 0x34 0x42 0x46 0x41 0x44 0x7dedwin2809-picoctf@webshell:~$ cat disassembled_asciiftw.txt | grep "<main>:" -A 40 | grep movb | cut -d "$" -f2 | cut -d "," -f1 | tr -d "\n" | sed 's\0x\ 0x\g' | sed 's\^ \\g
> 
> ^C
edwin2809-picoctf@webshell:~$ cat disassembled_asciiftw.txt | grep "<main>:" -A 40 | grep movb | cut -d "$" -f2 | cut -d "," -f1 | tr -d "\n" | sed 's\0x\ 0x\g' | sed 's\^ \\g'
